...
def load_initial_state(subscription: Email) -> State:
...
@terminate_workflow("Terminate email", initial_input_form=terminate_initial_input_form_generator, additional_steps=additional_steps)
def terminate_email() -> StepList:
    return (
        begin
        >> load_initial_state
